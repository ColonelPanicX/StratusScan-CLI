...
class ScriptExecutor:
    ...
    def _execute_script(self, script_path: Path) -> ExecutionResult:
        ...
        try:
            ...
            # Try to find output file (look for newly created Excel files)
            output_file = self._find_output_file(script_name)
    ...
    def _find_output_file(self, script_name: str) -> Optional[str]:
        """
