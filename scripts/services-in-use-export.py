...
Examples:
  ...
  python3 services-in-use-export.py --smart-scan --quick-scan
    ...
    print("=" * 68)
    print("\nThis script checks for resources across all AWS services.")
    print("More regions = more comprehensive (but slower)")
    print("\nPlease select an option for region selection:")
    print("\n  1. Default Regions")
    print(f"     ({example_regions})")
    print("\n  2. All Available Regions")
    print("     (Scan all regions for comprehensive service discovery)")
    print("\n  3. Specific Region")
