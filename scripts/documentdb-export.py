...
def main():
    ...
    print("=" * 68)
    print("\nDocumentDB is a regional service.")
    print("\nPlease select an option for region selection:")
    print("\n  1. Default Regions")
    print(f"     ({example_regions})")
    print("\n  2. All Available Regions")
    print("     (Scan all regions where DocumentDB is available)")
    print("\n  3. Specific Region")
    ...
    print(f"\nStarting DocumentDB export process for {len(regions)} region(s)...")
    utils.log_info(f"Scanning {len(regions)} AWS regions: {', '.join(regions)}")
